...
class CourseTest < ActiveSupport::TestCase
  def setup
    ...
    @course = @user.courses.build(name: "This is a course", description: "This is a description that is supposed to be more than 30 characters", prerequisite: "This is another course")
